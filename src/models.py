...
class CIFAR10_Monarch_MLP(nn.Module):
    ...
    def __init__(self, in_features, nblocks=1, out_features=10):
        super().__init__()
        self.fc1 = MonarchLinear(in_features, 392, nblocks=nblocks, bias=False)
        self.fc2 = MonarchLinear(392, 128,  nblocks=nblocks, bias=False)
        self.fc3 = MonarchLinear(128, 64,  nblocks=nblocks, bias=False)
        self.fc4 = MonarchLinear(64, out_features, nblocks=nblocks, bias=False)
